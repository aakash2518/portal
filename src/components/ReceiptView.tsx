  ...
  return (
    <div className="receipt-container border-2 border-black p-3 text-[11px] leading-tight h-full flex flex-col">
      ...
      <table className="w-full border-collapse text-[11px] mb-1">
        <tbody>
          <tr>
            <td className="border border-black p-[4px] font-semibold">Receipt No. : {data.receipt_number}</td>
            <td className="border border-black p-[4px] font-semibold">Receipt Date : {data.receipt_date}</td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]" colSpan={2}>Name : <strong>{data.student_name}</strong></td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]" colSpan={2}>Parent Name : <strong>{data.parent_name}</strong></td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]" colSpan={2}>Program : <strong>{data.program}</strong></td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]">Admission No. : {data.admission_number}</td>
            <td className="border border-black p-[4px]">ENROLLMENT NO. : {data.enrollment_number}</td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]">Month : <strong>{data.month}</strong></td>
            <td className="border border-black p-[4px]">Year : <strong>{data.year}</strong></td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]" colSpan={2}>Mob No. : <strong>{data.mobile_number}</strong></td>
          </tr>
          <tr>
            <td className="border border-black p-[4px]">Pay Mode : <strong>{data.pay_mode}</strong></td>
          ...
          <tr>
            <td className="border border-black p-[4px]" colSpan={2}>Collected By : <strong>{data.collected_by}</strong></td>
          </tr>
        </tbody>
      </table>
      ...
      <table className="w-full border-collapse text-[11px] flex-1">
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-black p-[4px] text-right">Rs. {data.fee_amount.toFixed(2)}/-</td>
          </tr>
          <tr className="font-bold">
            <td className="border border-black p-[4px]">Total Amount to Pay</td>
            <td className="border border-black p-[4px] text-right">Rs. {data.fee_amount.toFixed(0)}/-</td>
          </tr>
          <tr className="font-bold">
            <td className="border border-black p-[4px]">Net Amount</td>
            <td className="border border-black p-[4px] text-right">Rs. {data.net_amount.toFixed(0)}/-</td>
          </tr>
          <tr className="font-bold">
            <td className="border border-black p-[4px]">CGST (9 %)</td>
            <td className="border border-black p-[4px] text-right">Rs. {data.cgst_amount.toFixed(0)}/-</td>
          </tr>
          <tr className="font-bold">
            <td className="border border-black p-[4px]">SGST (9 %)</td>
            <td className="border border-black p-[4px] text-right">Rs. {data.sgst_amount.toFixed(0)}/-</td>
          </tr>
          ...
          <tr className="font-bold">
            ...
            <td className="border border-black p-[4px] text-right">Rs. {data.balance_due.toFixed(0)}/-</td>
          </tr>
        </tbody>
      </table>
